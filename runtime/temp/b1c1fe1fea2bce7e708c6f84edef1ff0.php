...
<div id="content-container">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow">历史数据新增-第三页</h1>
    </div>
    ...
    <div id="page-content">
        <form action="<?php echo url('admin/assess/saveThree',['id'=>$report_id]); ?>" method="post" class="form-horizontal" id="member-form">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <p class="bord-btm pad-ver text-main text-bold">社交行为及专注力</p>
                <div class="row">
                    <div class="col-sm-6">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php $__FOR_START_29917__=1;$__FOR_END_29917__=4;for($i=$__FOR_START_29917__;$i < $__FOR_END_29917__;$i+=1){ ?>
                                        <td><input id="sradio<?php echo $vo['id']; ?>-<?php echo $i; ?>" class="magic-radio" type="radio" name="report_e[radio][<?php echo $vo['id']; ?>]" value="<?php echo $val--; ?>">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-left"><?php echo $vo['cn_name']; ?><br><?php echo $vo['en_name']; ?></td>
                                        <?php $__FOR_START_8372__=1;$__FOR_END_8372__=4;for($i=$__FOR_START_8372__;$i < $__FOR_END_8372__;$i+=1){ ?>
                                        <td><input id="sradio<?php echo $vo['id']; ?>-<?php echo $i; ?>" class="magic-radio" type="radio" name="report_e[radio][<?php echo $vo['id']; ?>]" value="<?php echo $val--; ?>">
                                            <label for="sradio<?php echo $vo['id']; ?>-<?php echo $i; ?>"></label></td>
                                        <?php } ?>
                                    </tr>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-7 col-sm-offset-4">
                            <input type="hidden" name="report_e[version]" value="1">
