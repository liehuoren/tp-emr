<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:71:"D:\wamp64\www\tp-emr\public/../application/admin\view\user\profile.html";i:1503470625;s:70:"D:\wamp64\www\tp-emr\public/../application/admin\view\Public\base.html";i:1504166997;s:72:"D:\wamp64\www\tp-emr\public/../application/admin\view\public\header.html";i:1502359014;s:71:"D:\wamp64\www\tp-emr\public/../application/admin\view\public\aside.html";i:1502243740;s:73:"D:\wamp64\www\tp-emr\public/../application/admin\view\public\mainnav.html";i:1503561480;s:72:"D:\wamp64\www\tp-emr\public/../application/admin\view\public\footer.html";i:1502275958;s:73:"D:\wamp64\www\tp-emr\public/../application/admin\view\public\setting.html";i:1502243791;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
...
<div id="content-container">
    <div id="page-title">
        <div class="panel-control mar-top">
            <a class="btn btn-sm btn-white " onclick="window.history.back();"><i class="fa fa-angle-left"></i> 返回</a>
        </div>
        <h1 class="page-header text-overflow">个人信息</h1>
    </div>
            ...
            <div class="fixed-sm-200 fixed-lg-250 pull-sm-left">
                <div class="panel">
                    ...
                    <div class="text-center pad-all bord-btm">
                        <div class="pad-ver">
                            <img src="<?php echo $userself['profile']['avatar']; ?>" class="img-lg img-border img-circle" alt="Profile Picture">
                        </div>
                        <h4 class="text-lg text-overflow mar-no"><?php echo $userself['profile']['fullname']; ?></h4>
                    ...
                    <ul class="list-group bg-trans text-sm pad-btm">
                        ...
                        <li class="list-group-item list-item-sm text-primary text-semibold">
                            邮箱： <?php echo $userself['email']; ?>
                        </li>
                        <li class="list-group-item list-item-sm text-primary text-semibold"> 
                            手机号： <?php echo $userself['mobile']; ?>
                        </li>
                        <li class="list-group-item list-item-sm text-primary text-semibold"> 
                            年龄： <?php echo birthday($userself['profile']['birthday']); ?>
                        </li>
                        <li class="list-group-item list-item-sm text-primary text-semibold"> 
                            所在中心： <?php echo $userself['profile']['centers']['name']; ?>
                        </li>
                    </ul>
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <div class="panel-control pull-left">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#demo-tabs-box-2" data-toggle="tab">修改密码</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            ...
                            <form action="<?php echo url('admin/user/profileEdit'); ?>" method="post" class="form-horizontal">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">昵称</label>
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control" name="nickname" placeholder="" value="<?php echo $userself['profile']['nickname']; ?>">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control" name="fullname" placeholder="" value="<?php echo $userself['profile']['fullname']; ?>">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7 input-group date">
                                                <input type="text" class="form-control" id="birthday" name="birthday" placeholder="" value="<?php echo $userself['profile']['birthday']; ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <?php echo widget('City/index',['pid'=>$userself['profile']['pos_province'],'cid'=>$userself['profile']['pos_city'],'did'=>$userself['profile']['pos_district']]); ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="text" class="form-control" name="address" placeholder="" value="<?php echo $userself['profile']['address']; ?>">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <?php echo widget('center/index',['centers_id'=>$userself['profile']['centers']['id']]); ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <p class="form-control-static"><?php echo $userself['reg_time']; ?></p>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <p class="form-control-static"><?php echo $userself['reg_ip']; ?></p>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <p class="form-control-static"><?php echo $userself['last_login_time']; ?></p>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                <p class="form-control-static"><?php echo $userself['last_login_ip']; ?></p>
                            ...
                            <div class="tab-pane fade" id="demo-tabs-box-2">
                                <form class="form-horizontal" action="<?php echo url('admin/user/repassword'); ?>" method="post" id="profile-password">
                                <div class="row">
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">旧密码</label>
                                            <div class="col-lg-7">
                                                <input type="password" class="form-control" name="oldpassword" placeholder="" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-9">
